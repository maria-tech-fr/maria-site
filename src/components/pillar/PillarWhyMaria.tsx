        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {piliers.map((p, i) => (
            <Reveal key={i} delay={80 + i * 50} className="h-full">
              <article className="group/why flex h-full flex-col gap-3 rounded-[16px] border border-paper-edge bg-paper p-9 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-accent">
                <span
