...
export default function FormationCta({
  ...
  const secLib = ctaSecondaireLibelle || 'Découvrir nos services'
  ...
  return (
    <section className="relative overflow-hidden bg-ink px-6 py-22 text-center text-paper lg:px-30.5 lg:py-32">
      ...
      <div className="relative mx-auto flex max-w-[920px] flex-col items-center gap-7">
        ...
        <Reveal delay={100}>
          <h2 className="max-w-[18ch] font-display text-[44px] font-semibold leading-[1.02] tracking-[-0.03em] text-paper text-balance lg:text-[68px] lg:leading-[1.02]">
            {titre}
